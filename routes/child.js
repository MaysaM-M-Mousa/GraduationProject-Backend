...
router.get("/All", auth,verifyRoles(ROLES.Admin), childController.getAllChildren)
router.get("/:id", auth, verifyRoles(ROLES.Parent, ROLES.KindergartenOwner, ROLES.Admin), childController.getChild)
